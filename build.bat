...
"C:\Java_ME_platform_SDK_3.0\bin\preverify.exe" -classpath "C:\Java_ME_platform_SDK_3.0\lib\cldc_1.1.jar;C:\Java_ME_platform_SDK_3.0\lib\midp_2.0.jar" -d verified output
